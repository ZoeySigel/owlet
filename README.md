...
已有可运行的本地与云端版本：邀请码账号、商品与品牌、三套模板、草稿与版本、PNG / ZIP 导出、持久化任务、SSE、额度账本及管理后台。2026-09-07 已部署至阿里云轻量应用服务器，正式地址为 https://owl-et.me ，HTTPS 已启用。默认模拟模型，不产生上游费用；真实 BigModel 调用仍待账号与费率验证。
